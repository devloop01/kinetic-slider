(function () {
	window.rgbKineticSlider = function (options) {
		...
		options.backgroundDisplacementSprite = options.hasOwnProperty(
			...
			: "";
		options.cursorDisplacementSprite = options.hasOwnProperty("cursorDisplacementSprite")
		...
		options.cursorTextEffect = options.hasOwnProperty("cursorTextEffect")
			...
			: true;
		options.cursorScaleIntensity = options.hasOwnProperty("cursorScaleIntensity")
		...
		options.swipeDistance = options.hasOwnProperty("swipeDistance")
			...
			: 500;
		options.slideTransitionDuration = options.hasOwnProperty("slideTransitionDuration")
			? options.slideTransitionDuration
			: 1;
		options.transitionScaleIntensity = options.hasOwnProperty("transitionScaleIntensity")
			? options.transitionScaleIntensity
			: 40;
		options.transitionScaleAmplitude = options.hasOwnProperty("transitionScaleAmplitude")
		...
		options.swipeScaleIntensity = options.hasOwnProperty("swipeScaleIntensity")
			...
			: 0.3;
		options.transitionSpriteRotation = options.hasOwnProperty("transitionSpriteRotation")
		...
		options.imagesRgbEffect = options.hasOwnProperty("imagesRgbEffect")
			...
			: false;
		options.textsSubTitleDisplay = options.hasOwnProperty("textsSubTitleDisplay")
		...
		options.mobileTextTitleSize = options.hasOwnProperty("mobileTextTitleSize")
			...
			: 45;
		options.textTitleLetterspacing = options.hasOwnProperty("textTitleLetterspacing")
		...
		options.textSubTitleSize = options.hasOwnProperty("textSubTitleSize")
			...
			: 21;
		options.mobileTextSubTitleSize = options.hasOwnProperty("mobileTextSubTitleSize")
			? options.mobileTextSubTitleSize
			: 14;
		options.textSubTitleLetterspacing = options.hasOwnProperty("textSubTitleLetterspacing")
			? options.textSubTitleLetterspacing
			: 3;
		options.textSubTitleOffsetTop = options.hasOwnProperty("textSubTitleOffsetTop")
			? options.textSubTitleOffsetTop
			: 120;
		options.mobileTextSubTitleOffsetTop = options.hasOwnProperty("mobileTextSubTitleOffsetTop")
		...
		options.textsRgbIntensity = options.hasOwnProperty("textsRgbIntensity")
			...
			: 0.09;
		options.navTextsRgbIntensity = options.hasOwnProperty("navTextsRgbIntensity")
		...
		options.imagesRgbIntensity = options.hasOwnProperty("imagesRgbIntensity")
			...
			: 0.9;
		options.navImagesRgbIntensity = options.hasOwnProperty("navImagesRgbIntensity")
				...
				onUpdate: function () {
					...
					if (is_loaded === true) {
						...
						if (options.imagesRgbEffect == true) {
							...
							if (timelineTransition.progress() < 0.5) {
								splitRgbImgs.red = [
									-timelineTransition.progress() * options.navImagesRgbIntensity,
									0,
								];
								splitRgbImgs.green = [0, 0];
